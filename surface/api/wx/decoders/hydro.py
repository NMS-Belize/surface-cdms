...
from wx.models import RatingCurve, RatingCurveTable, Station
...
@shared_task
def read_file(filename, highfrequency_data=False, process_in_chunks=False, station_data_file=None, station_object=None, utc_offset=None, override_data_on_conflict=False):
